...
import br.ifba.inf011.model.adapter.ClassClosedProtocolAdapter;
import br.ifba.inf011.model.adapter.ClassNumeroZipAdapter;
...
public class Aplicacao {
	...
	public void send2() throws Exception {
		...
		ClassClosedProtocolAdapter protocolAdapter = new ClassClosedProtocolAdapter("network", 4545);
		...
		Mensageiro<String> mensageiro = new MensageiroINF011(protocolAdapter, 
															 ...
															 null, 
															 new AbertaCredencial(), 
															 new ClassNumeroZipAdapter());
		mensageiro.enviar("MENSAGEM ENVIADA PELO MENSAGEIRO NUMERO zero dois");
